...
function StarburstLogo() {
  return (
    <svg width="26" height="26" viewBox="0 0 28 28" fill="none">
      ...
      <line x1="14" y1="20" x2="14" y2="27" stroke="white" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="1"  y1="14" x2="8"  y2="14" stroke="white" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="20" y1="14" x2="27" y2="14" stroke="white" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="4.22"  y1="4.22"  x2="9.17"  y2="9.17"  stroke="white" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="18.83" y1="18.83" x2="23.78" y2="23.78" stroke="white" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="23.78" y1="4.22"  x2="18.83" y2="9.17"  stroke="white" strokeWidth="1.6" strokeLinecap="round" />
      <line x1="9.17"  y1="18.83" x2="4.22"  y2="23.78" stroke="white" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? "bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/8"
            : "bg-transparent"
        }`}
      >
      ...
      >
        <div className="flex flex-col px-6 py-4">
          ...
          <div className="flex flex-col gap-2.5 mt-6 mb-2">
            <Link href="/auth/login" className="text-center text-[#f0f0f0] text-[13px] font-medium px-4 py-3 rounded-lg border border-white/[0.14]">
              Log in
            </Link>
            <Link href="/auth/login" className="text-center bg-white text-black text-[13px] font-semibold px-4 py-3 rounded-lg">
              Get Started Free
            </Link>
          </div>
        </div>
